...
::: {.grid}
::: {.g-col-6}
- I am a research engineer as part of Inria P16, and I am the lead developer of skrub
  ::: {.fragment}
  ![](images/skrub.svg){width=150}
  :::
- I'm Italian, but I don't drink coffee, wine, and I like pizza with fries
  ::: {.fragment}
  ![](images/raora.png){width=50}
  :::
- I did my PhD in Côte d'Azur, and I moved away because it was too sunny and I don't like the sea
  ::: {.fragment}
  ![](images/nice.jpg){width=250}
  :::
:::

::: {.g-col-6}
<!-- Images will appear in sync with the list items via fragments above -->
:::
:::
