...
author: "Riccardo Cappuzzo, Jérôme Dockès, Guillaume Lemaitre"
...
## `whoami`
- I am a research engineer as part of Inria P16, and I am the lead developer of skrub ![](images/skrub.svg){width=150}
...
## On compatibility
Skrub is fully compatible with pandas and polars, and the transformers it provides
are fully compatible with scikit-learn, and can be used directly in scikit-learn pipelines.

Skrub is intended to save the effort required to perform common data preprocessing, 
with either of the dataframe libraries. 

## An example pipeline
1. Gather some data
2. Explore the data
3. Pre-process the data 
4. Perform feature engineering with Pandas or Polars
...
## Data cleaning with Pandas/Polars {.smaller auto-animate="true"}
...
- Textual features: `skrub.TextEncoder` and Huggingface models
...
```
## Tunings with `DataOps` is not limited to estimators
::: {.panel-tabset}
### Pandas
```{python}
import pandas as pd
