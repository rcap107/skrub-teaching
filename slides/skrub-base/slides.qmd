...
## `whoami` 
- I am a research engineer at Inria in the P16 team, and I am the lead developer of skrub ![](images/skrub.svg){width=70}
::: {.content-visible when="base"}
- I'm Italian, but I don't drink coffee, wine, and I like pizza with fries
:::
::: {.content-visible when="memes"}
...
## {auto-animate="true" .content-visible when="memes"} 
...
## Sprint on friday! {.content-visible when=""}
